...
export default function HomePage() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-tablepong-light via-white to-slate-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
            {/* Hero Section */}
            <div className="relative overflow-hidden">
                {/* Background decoration */}
                <div className="absolute inset-0 overflow-hidden">
                    <div className="absolute -top-40 -right-40 h-80 w-80 rounded-full bg-tablepong-navy/20 blur-3xl" />
                    <div className="absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-tablepong-red/10 blur-3xl" />
                </div>
                ...
                <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <p className="mx-auto mb-10 max-w-xl text-gray-500 dark:text-gray-400">
                            Controla inventario, POS, mesas y costos en tiempo real
                        </p>
                        ...
                        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row px-4">
                            <Link
                                href="/dashboard"
                                className="group relative inline-flex w-full sm:w-auto items-center justify-center gap-2 overflow-hidden rounded-xl bg-primary px-8 py-4 text-lg font-semibold text-white shadow-lg shadow-primary/30 transition-all hover:shadow-xl hover:shadow-primary/40"
                            >
                                ...
                                <div className="absolute inset-0 bg-tablepong-red opacity-0 transition-opacity group-hover:opacity-100" />
                            </Link>
                        </div>
                    </div>
                </div>
            ...
            <div className="relative mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
                <div className="grid gap-6 md:grid-cols-3">
                    {/* Feature 1 */}
                    <div className="group rounded-2xl border border-primary/20 bg-white/80 p-6 shadow-sm backdrop-blur-sm transition-all hover:border-primary/40 hover:shadow-md dark:border-gray-700 dark:bg-gray-800/80">
                    ...
                    {/* Feature 3 */}
                    <div className="group rounded-2xl border border-primary/20 bg-white/80 p-6 shadow-sm backdrop-blur-sm transition-all hover:border-primary/40 hover:shadow-md dark:border-gray-700 dark:bg-gray-800/80">
                        <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary text-2xl text-white shadow-lg shadow-primary/25">
                            💰
                        </div>
                        <h3 className="mb-2 text-lg font-semibold text-gray-900 dark:text-white">
