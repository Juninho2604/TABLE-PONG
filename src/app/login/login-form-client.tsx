...
function SubmitButton() {
    ...
    return (
        <button
            type="submit"
            className="w-full rounded-lg bg-primary px-4 py-3 font-semibold text-white shadow-lg transition-transform hover:scale-[1.02] disabled:opacity-70 disabled:hover:scale-100"
            disabled={pending}
        >
            {pending ? (
            ...
            <div>
                ...
                <div className="mt-1">
                    <input
                        ...
                        className="block w-full rounded-lg border border-gray-300 px-4 py-3 placeholder-gray-400 focus:border-primary focus:outline-none focus:ring-primary sm:text-sm"
                    />
                </div>
            </div>
