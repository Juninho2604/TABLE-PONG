/**
 * TABLE PONG ERP — Module Registry
 *
...
export const MODULE_REGISTRY: ModuleDefinition[] = [
  ...
  },
  {
    id: 'sku_studio',
    label: 'SKU Studio',
    description: 'Creación guiada de productos con familias y plantillas',
    icon: '🎨',
  ...
  // ═══════════════════════════════════════════
  {
    id: 'pos_sportbar',
    label: 'POS Sport Bar',
    description: 'Punto de venta para la barra de Sport Bar',
    icon: '🍺',
  ...
  {
    id: 'subtabs',
    label: 'Subcuentas (SubTabs)',
    description: 'División de cuentas dentro de una mesa: cobrar por separado sin cerrar la mesa',
    icon: '🪑',
    href: '/dashboard/pos/sportbar',
    section: 'sales',
    enabledByDefault: true,
    sortOrder: 212,
    tags: ['subtabs', 'subcuentas', 'sportbar'],
  },
  {
    id: 'cierre_ciego',
    label: 'Cierre Ciego',
    description: 'Proceso de cierre de caja ciego: el cajero declara sin ver el total del sistema',
    icon: '🔒',
    href: '/dashboard/pos/cierre-ciego',
    section: 'sales',
    enabledByDefault: true,
    sortOrder: 215,
    tags: ['caja', 'cierre', 'ciego'],
  },
  {
    id: 'sales_entry',
    label: 'Cargar Ventas',
  ...
  // ═══════════════════════════════════════════
  {
    ...
    enabledByDefault: true,
    sortOrder: 270,
    tags: ['caja', 'sesion', 'apertura', 'cierre', 'efectivo'],
  },
...
export const MODULE_ROLE_ACCESS: Record<string, string[]> = {
  ...
  // Ventas / POS
  pos_sportbar: ['OWNER', 'ADMIN_MANAGER', 'OPS_MANAGER', 'CASHIER_RESTAURANT'],
  ...
  subtabs: ['OWNER', 'ADMIN_MANAGER', 'OPS_MANAGER', 'CASHIER_RESTAURANT'],
  cierre_ciego: ['OWNER', 'ADMIN_MANAGER', 'OPS_MANAGER', 'CASHIER_RESTAURANT', 'CASHIER_DELIVERY'],
  ...
  // Financiero / Caja
  cash_session: ['OWNER', 'ADMIN_MANAGER', 'OPS_MANAGER', 'CASHIER_RESTAURANT', 'CASHIER_DELIVERY', 'AUDITOR'],
  // Intercompany
  ...
  module_config: ['OWNER'], // Solo el OWNER puede activar/desactivar módulos del sistema
